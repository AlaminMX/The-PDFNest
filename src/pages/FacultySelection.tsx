            ...
            : visibleFaculties.map((faculty, index) => (
                ...
                >
                  <button
                    ...
                    className="w-full text-left p-5 rounded-xl bg-muted/30 hover:bg-muted/50 border border-border/20 hover:border-border/40 transition-all duration-200 group"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-medium mb-0.5">{faculty.name}</h3>
                        <p className="text-xs text-muted-foreground">
                          {faculty.department_count} {faculty.department_count === 1 ? "department" : "departments"}
                        </p>
                      </div>
